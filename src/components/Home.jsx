...
function Home() {
    return (
        <div name="home" className='min-h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 flex justify-center items-center md:items-start'>
            <div className='w-full flex flex-col h-full px-4 md:flex-row md:mt-24 md:items-center'>
            
            
                    <img src={HeroPic} alt='profile' className='rounded-full shadow-2xl h-[250px] w-[200px] mb-5 md:hidden self-center' />
                ...
                <div className='flex flex-col justify-center h-full md:w-3/4 md:ml-40'>
                    ...
                    <div className='flex gap-4'>
                        <Link to='services' smooth duration={500} className='text-xs md:text-base group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer'>Services
                            <span className='group-hover:rotate-90 duration-300'>
                                <MdOutlineKeyboardArrowRight size={25} className='ml-1' />
                            </span>
                        </Link>
                        <Link to='contact' smooth duration={500} className='text-xs md:text-base group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer'>Book Appointment
                            <span className='group-hover:rotate-90 duration-300'>
                                <MdOutlineKeyboardArrowRight size={25} className='ml-1' />
                            </span>
                        </Link>
